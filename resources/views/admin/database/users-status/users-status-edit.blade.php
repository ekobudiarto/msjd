	...
	<div class="module-body">
			...
			{!! Form::open(array('url' => 'admin/users-status/'.$value->users_status_id, 'files' => false, 'class' => 'form-horizontal row-fluid')) !!}
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" required id="basicinput" placeholder="title" class="span8" name="users_status_title" value="{{ $value->users_status_title }}">
					</div>
				</div>
				<div class="control-group">
					<label class="control-label" for="basicinput">Description</label>
					<div class="controls">
						<textarea class="span8" rows="5" id="editor" name="users_status_desc">{{ $value->users_status_desc }}</textarea>
					</div>
				</div>
				<div class="control-group">
					<div class="controls">
