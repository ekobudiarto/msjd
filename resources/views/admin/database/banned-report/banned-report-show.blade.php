			...
			{!! Form::open(array('url' => 'admin/banned-report/'.$value->banned_report_id, 'files' => false, 'class' => 'form-horizontal row-fluid')) !!}
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<input type="text" disabled id="usrBy" placeholder="" style="width: 65.812%;" required />
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<input type="text" disabled id="contentId" placeholder="" style="width: 65.812%;" required />
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<input type="text" disabled id="usrDest" placeholder="" style="width: 65.812%;" required />
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea disabled class="span8" rows="5" id="editor" name="banned_report_message">{{ $value->banned_report_message }}</textarea>
					</div>
				</div>
				<div class="control-group">
					<div class="controls">
