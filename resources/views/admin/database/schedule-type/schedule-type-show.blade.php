	...
	<div class="module-body">
			...
			{!! Form::open(array('url' => 'admin/schedule-type/'.$value->schedule_type_id, 'files' => false, 'class' => 'form-horizontal row-fluid')) !!}
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" disabled required id="basicinput" placeholder="text" class="span8" name="schedule_type_name" value="{{ $value->schedule_type_name}}">
					</div>
				</div>
				<div class="control-group">
					<label class="control-label" for="basicinput">Schedule Type Description</label>
					<div class="controls">
						<textarea disabled class="span8" id="editor" rows="5" name="schedule_type_desc" >{{ $value->schedule_type_desc}}</textarea>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						...
						<input type="text" disaled required id="mediaId" style="width: 65.812%;" />
