...
class controller_search extends Controller
{
    ...
    public function getSearchHashtag()
    {
        ...
        $applicants =  DB::select("select * FROM `table_hashtag`
                            where ".$select." like '%".$query."%' ");
    ...
    public function getSearchMediaManager()
    {
        ...
        $applicants =  DB::select("select * FROM `table_media_manager`
                            where ".$select." like '%".$query."%' ");
    ...
    public function getSearchScheduleType()
    {
        ...
        $applicants =  DB::select("select * FROM `table_schedule_type`
                            where ".$select." like '%".$query."%' ");
    ...
    public function getSearchUsersGroup()
    {
        ...
        $applicants =  DB::select("select * FROM `table_users_group`
                            where ".$select." like '%".$query."%' ");
    ...
    public function getSearchUsersStatus()
    {
        ...
        $applicants =  DB::select("select * FROM `table_users_status`
                            where ".$select." like '%".$query."%' ");
    ...
    public function getSearchUsersDetail()
    {
        ...
        $applicants =  DB::select("select * FROM `table_users_detail`
                            where ".$select." like '%".$query."%'");
